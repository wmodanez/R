...
# Exercícios - Para Resolução em Sala com o uso de **objetos** como um data.frame, vetores e matrizes, valendo-se do uso da família **apply()** e da **composição** de **funções** predefinidas nos **packages** ou mesmo **criadas** pelo usuário.
 ...
 9) Realize um teste de hipótese para verificar se há uma **diferença estatísticamente significante** entre a altura, o peso e o IMC das pessoas do sexo feminino e masculino que foram observadas desde a aula do dia 11 abr. 2018. Se houver, indique o respectivo *Intervalo de Confiança (IC)*, a *margem de erro (E)* e o valor de *Z crítico* ($Z\_frac{\alpha} {2}) para cada variável observada.  
...
boxplot(rs$peso~rs$sexo, ylab = "peso", xlab="sexo") # homens são, em média, mais pesados que as mulheres
plot(rs$peso~rs$h, ylab = "peso", xlab="altura")
rs$h2<-rs$h^2
plot(rs$peso~rs$h2, ylab = "peso", xlab="altura^2")
