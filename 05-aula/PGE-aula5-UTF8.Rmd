---
title: 'Noções Básicas de R - Aula 5'
...
AULA N. 05 - EXERCÍCIOS COM OBJETOS: *VETORES*, **MATRIZES**, **DATA.FRAME**, ARRAYS, **LIST**, *DATE*, TS, LM, GDAL etc.
...
library(dplyr)
getwd()
dados.teste<-read.csv2(file = "Tabela-pesos-altura-corrigida3.csv", header = TRUE, sep = ";", quote = "\"", dec = ".", fill = TRUE)
dados.teste
#View(dados.teste)
dez_semanas
dez_semanas+7
colnames(dados.teste[3:12])<-as.character.Date(dez_semanas+7)
dados.teste
names(dados.teste)
colnames(dados.teste)
```
